    ...
    public class SecondroomController : ControllerBase
    {
        ...
        public JsonResult SearchBtn(string dishname, string price1, string price2)
        {
            ...
            try
            {
                ...
                {
                    string sql2 = "SELECT * FROM [demo].[dbo].[secondroom] WHERE price between  " + int.Parse(price1) + "  and " + int.Parse(price2) + "";
                ...
                else if (dishname != "" && price1 != "" && price2 == "")
                {
                    ...
                    string sql3 = "SELECT * FROM [demo].[dbo].[secondroom]  where dishname like'" + dishname + "%' and price =" + int.Parse(price1) + "";
                ...
                else if (dishname != "" && price1 == "" && price2 != "")
                {
                    ...
                    string sql4 = "SELECT * FROM [demo].[dbo].[secondroom]  where dishname like'" + dishname + "%'  and  price =" + int.Parse(price2) + "";
                ...
                {
                    string sql5 = "SELECT * FROM [demo].[dbo].[secondroom]  where  price  =" + int.Parse(price2) + "";
                ...
                {
                    string sql6 = "SELECT * FROM [demo].[dbo].[secondroom]  where  price =" + int.Parse(price1) + "";
                ...
                else
                {
                    ...
                    string sql7 = "SELECT * FROM [demo].[dbo].[secondroom] where dishname like'" + dishname + "%' and price between  " + int.Parse(price1) + " and " + int.Parse(price2) + "";
